...
app.config["MYSQL_DATABASE_HOST"] = os.getenv("BLUE_TEST_DB_SVC_SERVICE_HOST")
app.config["MYSQL_DATABASE_PORT"] = int(os.getenv("BLUE_TEST_DB_SVC_SERVICE_PORT"))
mysql.init_app(app)

@app.route("/")
def index():
    """Function to test the functionality of the API"""
    return "BLUE: I am healthy and functioning"
