...
app.config["MYSQL_DATABASE_HOST"] = os.getenv("MYAPP_TEST_DB_SVC_SERVICE_HOST")
app.config["MYSQL_DATABASE_PORT"] = int(os.getenv("MYAPP_TEST_DB_SVC_SERVICE_PORT"))
mysql.init_app(app)

@app.route("/")
def index():
    """Function to test the functionality of the API"""
    return "I am healthy and functioning"
